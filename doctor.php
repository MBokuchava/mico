    ...
    <div class="container">
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel team_carousel">
            <!-- გადინამიურებული Our Doctors სექცია -->
            <?php
                foreach ($doctors as $doctor) {
                    echo '<div class="item">';
                    echo '<div class="box">';
                    echo '<div class="img-box">';
                    echo '<img src="' . $doctor['image'] . '" alt="" />';
                    echo '</div>';
                    echo '<div class="detail-box">';
                    echo '<h5>' . $doctor['name'] . '</h5>';
                    echo '<h6>' . $doctor['qualification'] . '</h6>';
                    echo '<div class="social_box">';

                    foreach ($doctor['socialLinks'] as $link) {
                        echo '<a href="' . $link['url'] . '">';
                        echo '<i class="' . $link['iconClass'] . '" aria-hidden="true"></i>';
                        echo '</a>';
                    }
